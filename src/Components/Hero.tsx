    ...
    >
      ...
      <div className=" text-white p-6">
        ...
        <div className="flex justify-center mb-[100px]">
          <div className=" flex justify-center gap-2 mt-6 px-6 py-3 bg-yellow-400 text-black text-lg w-[200px] font-semibold rounded-xl hover:bg-yellow-500 transition cursor-pointer">
        ...
        {/* Scroll down */}
        <span className="text-xlg font-semibold mt-[50px] cursor-pointer">تابع للأسفل</span>
        <img className="absolute left-[50px] bottom-[-20px]" src={arrow} alt="" />
      </div>
